    ...
    <div class="wrapper">
        <div class="form-user">
            ...
            <form method="post" action="{{route('register')}}" class="form-entry">
                @csrf
                <div class="title">
                    <h2 class="form-title"> Registrati per poter iniziare! </h2>
                </div>
                @error('name')
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <input type="text" class="input" name="surname" placeholder="Cognome">
                @error('email')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <input type="text" class="input" name="Provincia" placeholder="Provincia">
                @error('Città')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
